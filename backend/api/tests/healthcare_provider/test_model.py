...
class TestHealthcareProvvider:
    def test_provider_positive_experience(self, healthcare_provider_factory):
    ...
    def test_provider_fees_positive(self, healthcare_provider_factory):
    ...
    def test_provider_license_regex(self, healthcare_provider_factory, bad):
        p = healthcare_provider_factory.build(license_number=bad)
        with pytest.raises(ValidationError, match="valid_license_format"):
            p.validate_constraints()

    def test_valid_license_passes(self, healthcare_provider_factory):
