      ...
      >
        ...
        <div className="shrink-0 flex flex-col items-end gap-2">
          ...
          {item.status === "COMPLETED" && (
            <button
              className="px-3 py-1.5 body-xs border rounded bg-primary text-white hover:bg-primary-dark transition-colors"
              aria-label={`View medical record for appointment with ${item.providerName}`}
