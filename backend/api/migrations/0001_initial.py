# Generated by Django 5.2.11 on 2026-03-24 22:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address_line1",
                    models.CharField(
                        blank=True, max_length=1024, verbose_name="Address line 1"
                    ),
                ),
                (
                    "address_line2",
                    models.CharField(
                        blank=True, max_length=1024, verbose_name="Address line 2"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blood_type",
                    models.CharField(
                        blank=True, max_length=5, verbose_name="Blood Type"
                    ),
                ),
                ...
                (
                    "insurance",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Insurance"
                    ),
                ),
                (
                    "weight",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="api.ProviderHospitalAssignment",
        ...
        migrations.AddIndex(
            model_name="slot",
            index=models.Index(
                fields=["healthcare_provider", "start", "status"],
                name="api_slot_healthc_9c0d6c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="slot",
            index=models.Index(
                fields=["hospital", "start", "status"],
                name="api_slot_hospita_75e4db_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="slot",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["healthcare_provider", "is_active"],
                name="api_provide_healthc_f9665f_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="providerhospitalassignment",
        ...
        migrations.AddConstraint(
            model_name="healthcareprovider",
            constraint=models.CheckConstraint(
                condition=models.Q(("fees__gt", 0)), name="fees_above_0"
            ),
        ),
        migrations.AddConstraint(
            model_name="healthcareprovider",
            constraint=models.CheckConstraint(
                condition=models.Q(("license_number__regex", "^[A-Z0-9]{6,20}$")),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    (
                        "appointment_end_datetime_utc__gt",
                        models.F("appointment_start_datetime_utc"),
                    )
                ),
