...
class TestAppointmentWorkflow:
    ...
    def test_patient_books_appointment_flow(self, authenticated_patient_client,
    ...
    def test_appointment_rescheduling_flow(self, authenticated_patient_client,
                                           authenticated_provider_client,
                                           appointment_factory, slot_factory):
        ...
        original_start = timezone.make_aware(
            datetime.combine(base_date, time(10, 0))
        )
        ...
        new_start = timezone.make_aware(
            datetime.combine(new_date, time(10, 0))
        )
    ...
    def test_appointment_cancellation_flow(self, authenticated_patient_client,
                                        authenticated_provider_client,
                                        appointment_factory, slot_factory):
        ...
        cancelled_appointments = [
            appt for appt in provider_response.data 
