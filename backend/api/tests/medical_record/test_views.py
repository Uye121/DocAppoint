...
class TestMedicalRecordViewSet:
    ...
    def test_get_queryset_for_provider(self, healthcare_provider_factory, medical_record_factory):
    ...
    def test_get_queryset_excludes_removed_records(self, medical_record_factory):
        ...
        removed_record = medical_record_factory(is_removed=True, removed_at=timezone.now())
    ...
    def test_list_records_as_provider(self, healthcare_provider_factory, medical_record_factory):
    ...
    def test_stats_action_as_provider(self, healthcare_provider_factory, medical_record_factory):
        provider = healthcare_provider_factory()
    ...
    def test_search_by_diagnosis(self, medical_record_factory):
        ...
        medical_record_factory(healthcare_provider=provider, diagnosis='COVID-19 pneumonia')
