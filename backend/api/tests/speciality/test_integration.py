...
class TestSpecialityPublicAccess:
    ...
    def test_authenticated_user_can_list_specialities(
        self, authenticated_patient_client, speciality_factory
    ):
...
class TestSpecialityStaffAccess:
    ...
    def test_staff_can_update_speciality(
        self, authenticated_admin_client, speciality_factory
    ):
    ...
    def test_staff_can_soft_delete_speciality(
        self, authenticated_admin_client, speciality_factory
    ):
    ...
    def test_staff_can_restore_speciality(
        self, authenticated_admin_client, speciality_factory
    ):
    ...
    def test_staff_cannot_create_duplicate_speciality(
        self, authenticated_admin_client, speciality_factory
    ):
        ...
        image = SimpleUploadedFile(
            "cardiology2.jpg", b"file_content", content_type="image/jpeg"
        )
        ...
        assert (
            "unique" in str(response.data).lower()
...
class TestSpecialityNonStaffAccess:
    ...
    def test_patient_cannot_update_speciality(
        self, authenticated_patient_client, speciality_factory
    ):
    ...
    def test_provider_cannot_update_speciality(
        self, authenticated_provider_client, speciality_factory
    ):
    ...
    def test_patient_cannot_delete_speciality(
        self, authenticated_patient_client, speciality_factory
    ):
...
class TestSpecialityProviderRelationship:
    ...
    def test_speciality_assigned_to_provider(
        self, speciality_factory, provider_factory
    ):
    ...
    def test_speciality_deleted_provider_handling(
        self, authenticated_admin_client, speciality_factory, provider_factory
    ):
    ...
    def test_speciality_set_to_null_when_deleted(
        self, authenticated_admin_client, speciality_factory, provider_factory
    ):
    ...
    def test_filter_providers_by_speciality(
        self, authenticated_patient_client, speciality_factory, provider_factory
    ):
...
class TestSpecialityImageHandling:
    ...
    def test_speciality_image_update(
        self, authenticated_admin_client, speciality_factory
    ):
    ...
    def test_speciality_image_deleted_on_delete(
        self, authenticated_admin_client, speciality_factory, tmp_path
    ):
        ...
        image = SimpleUploadedFile(
            "delete_test.jpg", b"content", content_type="image/jpeg"
        )
...
class TestSpecialityFiltering:
    ...
    def test_search_specialities_by_name(
        self, authenticated_patient_client, speciality_factory
    ):
    ...
    def test_filter_active_specialities(
        self, authenticated_patient_client, speciality_factory
    ):
