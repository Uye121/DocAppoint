...
from ..models import HealthcareProviderProfile, Hospital, ProviderHospitalAssignment
...
class HealthcareProviderService:
    @staticmethod
    @transaction.atomic
    def create_provider_profile(user: User, profile_data: dict) -> HealthcareProviderProfile:
    ...
    @staticmethod
    def get_provider_profile(user: User) -> Optional[HealthcareProviderProfile]:
        try:
