...
class TestMedicalRecordFlow:
    def test_provider_creates_medical_record_flow(
        self,
    ...
    def test_patient_views_their_medical_records(
        self, authenticated_patient_client, provider_factory, medical_record_factory
    ):
        ...
        assert (
            response.data["patientDetails"]["fullName"] == patient.user.get_full_name()
        )

    def test_provider_updates_medical_record(
        self, authenticated_provider_client, medical_record_factory
    ):
    ...
    def test_provider_can_update_others_records(
        self, authenticated_provider_client, provider_factory, medical_record_factory
    ):
    ...
    def test_provider_soft_deletes_medical_record(
        self, authenticated_provider_client, medical_record_factory
    ):
    ...
    def test_admin_can_view_soft_deleted_records(
        self, authenticated_admin_client, medical_record_factory
    ):
    ...
    def test_medical_record_stats_endpoint(
        self,
        authenticated_provider_client,
        ...
        medical_record_factory(
            healthcare_provider=provider, created_at=timezone.now() - timedelta(days=45)
        )
    ...
    def test_medical_record_filtering_and_search(
        self,
        authenticated_provider_client,
        patient_factory,
        hospital_factory,
