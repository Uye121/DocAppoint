...
__all__ = [
    ...
    'MedicalRecord', 'Message', 'Speciality', 'PatientManager',
    'HealthcareProviderManager', 'AdminStaffManager', 'SystemAdminManager',
    'PatientProfile', 'HealthcareProviderProfile', 'AdminStaffProfile',
    'SystemAdminProfile'
]